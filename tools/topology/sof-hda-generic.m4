...
#
# PCM0P --> volume     (pipe 1) --> HDA Analog (HDA Analog playback/capture)
# PCM0C <-- volume, EQ (pipe 2) <-- HDA Analog (HDA Analog playback/capture)
# PCM1P --> volume     (pipe 3) --> HDA Digital (HDA Digital playback/capture)
# PCM1C <-- volume, EQ (pipe 4) <-- HDA Digital (HDA Digital playback/capture)
